...
Why use liquid nitrogen  if we know the challenges in maintaining consistent temperatures across the globe at sea level Vs mountain tops, equator Vs poles... and don't forget the need to stochastically harmonize data sampling fluctuations across the world's time zones... Quantum Computing involves the potential issue of duplicative sampling and arriving at A.I. group think faster where the result is faster but not necessarily more accurate. 
