...
3) All things internet, net of money, QFS, AI blockchains, hash-graphs etc.,  (time chains) are formed with unicast, multicast, anycast protocols. (statistically predictive) workflow logic, propagated by wave form motion described by nature, natural law I.e., Tesla described electro - gravitic - magnetic wave forms (standing, scaler waves)
