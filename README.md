...
INTRODUCTION: Eco sustainable Economic Epochs used to program programmable money and the programmable Economy that is agreed to by DAO Trade Federations and supported by a system of systems engineering framework representing DoD / NATO best practice over the past three decades as OOTW Operations Other Than War -- a German military suggestion to reuse Battlefield Digitization / Network Centric Operations system of systems enegineering framework
