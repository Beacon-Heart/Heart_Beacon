...
FUNDAMENTAL TRUTH: blockchains are formed by unicast, multicast,anycast and workflow filters. Programmable money’s improvements are in cryptography. Internet 3.0 and the new web will be based on the original mechanmisms used by Stanford University.  There are no packets, frames, blocks, Satoshi's traversing the net to be stored in a cube.
