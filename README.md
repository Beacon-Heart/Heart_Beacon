...
QUANTUM COMPUTING RESISTANT / BASED / BOTH? Are your patent applications, patents described with SCOTUS Alice Corp Vs CLS Bank in mind? are they future proofed? What if events could be detected, recorded by waves? - is there a need for liquid nitrogen if the method and means is light wave laser based? Why go the liquid nitrogen route if we know the challenges in maintaining consistent temperatures across the globe at sea level Vs mountain tops, equator Vs poles... and don't forget the need to stochastically harmonize data sampling fluctuations across the world's time zones... My personal opinion for what it's worth is that Quantum Computing involves the potential issue of duplicative sampling and arriving at A.I. group think faster where the result is faster but not necessarily more accurate.
...
QUESTION (S): Are your patent applications, patents written and described with SCOTUS Alice Corp Vs CLS Bank in mind? are your patent applications, patents descriptive to the quantum computing level & future proofed? Are they written to be quantum resistant or quantum based or both? What if events could be propagated by waves - is there a need for liquid nitrogen if the method and means is light wave laser based? Why go the liquid nitrogen route if we know the challenges in maintaining consistent temperatures across the globe at sea level Vs mountain tops, equator Vs poles... and don't forget the need to stochastically harmonize data sampling fluctuations across the world's time zones... My  opinion is that Quantum Computing involves the issue of duplicative sampling, reporting and arriving at A.I. group think faster where results are not necessarily more accurate. 
